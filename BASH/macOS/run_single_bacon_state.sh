...
# The first example below shows how you would reference a MacOS state called "Install Chrome" with an id of 17.

# If you want a script that only ever applies a single state, you can use
# this example:
/opt/salt/bin/salt-call state.apply bacon.states.MacOS.install-chrome_17
