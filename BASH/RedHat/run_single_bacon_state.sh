...
# The first example below shows how you would reference a CentOS state called "Install Chrome" with an id of 19.

# If you want a script that only ever applies a single state, you can use
# this example:
/opt/salt/bin/salt-call state.apply bacon.states.CentOS.install-chrome_19
